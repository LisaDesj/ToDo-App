...
//  throws InvalidProgressException if !(0 <= progress <= 100)
    public void setProgress(int progress) {
        if (progress < 0 || progress > 100) {
            throw new InvalidProgressException("Progress is out of bounds");
        }
...
//  throws NegativeInputException if hours < 0
    public void setEstimatedTimeToComplete(int hours) {
        if (hours < 0) {
            throw new NegativeInputException("Hours cannot be set to less than zero");
        }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(description, task.description)
                ...
                && Objects.equals(getPriority(), getPriority())
                && status == task.status;
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash(description, dueDate, getPriority(), status);
    }
}
