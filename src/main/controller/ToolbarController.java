...
public class ToolbarController implements Initializable {
    ...
    class ViewOptionsPopUpController {
        ...
        private void submit() {
            ...
            switch (selectedIndex) {
                case 0:
                    Logger.log("ViewOptionsPopUpController", "List View Selected");
                    break;
                case 1:
                    Logger.log("ViewOptionsPopUpController", "Priority View is not supported in this version!");
                    break;
                case 2:
                    Logger.log("ViewOptionsPopUpController", "Status View is not supported in this version!");
                    break;
                default:
                    Logger.log("ViewOptionsPopUpController", "No action is implemented for the selected option");
            }
            viewPopUp.hide();
        }
    }
    ...
    class ToolbarPopUpController {
        ...
        private void submit() {
            ...
            switch (selectedIndex) {
                case 0:
                    Logger.log("ToolbarPopUpController", "Setting is not supported in this version");
                    break;
                case 1:
                    Logger.log("ToolbarPopUpController", "Close application");
                    Platform.exit();
                    break;
                default:
                    Logger.log("ToolbarPopUpController", "No action is implemented for the selected option");
            }
            toolbarPopUp.hide();
        }
    }
